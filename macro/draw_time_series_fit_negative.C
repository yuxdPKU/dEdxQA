...
void draw_time_series_fit_negative(std::string infile = "run_ratio_negative.txt") {
  ...
  while (inputFile2 >> runNo >> ratio)
  {
    ...
    //if (ratio>2) continue;
if (runNo>51550) continue;
if (runNo<51340) continue;
//cout<<"runNo = "<<runNo<<endl;
  ...
  TPaveText *pt = new TPaveText(0.50, 0.65, 0.9, 0.9, "brNDC");
  ...
  c1->Print("figure/pp_dedx_time_series_zoomin_negative.pdf");
}
