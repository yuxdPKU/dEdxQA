...
void draw_time_series_positive(std::string infile = "run_ratio_positive.txt") {
  ...
  pt->AddText(Form("HighZ: [80,100] cm"));
  pt->AddText(Form("LowZ: [0,20] cm"));
  pt->SetTextAlign(12);
  pt->SetTextFont(42);
  pt->SetTextSize(0.04);
  pt->SetFillStyle(0);
  ...
  c1->Print("figure/pp_dedx_time_series_positive.pdf");
}
